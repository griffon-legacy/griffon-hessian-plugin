 ...
 */
public class HandleHessianAware extends EclipseAnnotationHandler<HessianAware> {
    ...
    public void handle(AnnotationValues<HessianAware> annotation, Annotation source, EclipseNode annotationNode) {
        ...
        EclipseUtil.addInterface(type.get(), HessianAwareConstants.HESSIAN_CONTRIBUTION_HANDLER_TYPE, source);
    ...
    private static class EclipseHessianAwareHandler extends HessianAwareHandler<EclipseType> {
    }
}
